...
(* OASIS_START *)
(* DO NOT EDIT (digest: 9e15733f633edee0779144399d22baa3) *)
(*
...
let setup_t =
  {
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build Unix userspace implementation and tools";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build Xen kernelspace implementation";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("mirage-types",
                               Some (OASISVersion.VGreaterEqual "1.1.3"));
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "vchan";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "vchan_lwt_unix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Vchan_xen"; "Events_xen"; "Memory_xen"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "vchan";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("lwt", None);
                           InternalLibrary "vchan";
                           InternalLibrary "vchan_lwt_unix"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = false; exec_main_is = "xencat.ml"});
               Doc
                 ({
                     cs_name = "api";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "01\0293(M\030c\200\tG\137\029\023\202\007";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
